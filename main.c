...
int main() {
	...
	char* a8 = "eve";
	char* s8 = "tokyo ghetto";
	//list = insert_front(list, s8, a8);
	list = insert_order(list, s8, a8);

	char* a9 = "teniwoha";
	char* s9 = "villain";
	//list = insert_front(list, s9, a9);
	list = insert_order(list, s9, a9);
	...
	library = add_song(library, s8, a8);

	library = add_song(library, s9, a9);
